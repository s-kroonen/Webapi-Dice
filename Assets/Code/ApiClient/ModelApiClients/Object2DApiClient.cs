...
public class Object2DApiClient : MonoBehaviour
{
    ...
    {
        string route = $"{Route}/{environmentId}/objects";
    ...
    {
        string route = $"{Route}/{object2D.environmentId}/objects";
    ...
    {
        string route = $"{Route}/{object2D.environmentId}/objects/{object2D.id}";
        string data = JsonUtility.ToJson(object2D);
